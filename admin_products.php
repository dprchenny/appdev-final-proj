...
<?php
    foreach ($result as $fieldname) {
        ...
        <a href = 'delete_product.php?deleteproduct=".$fieldname['product_id']."' class='delete' onclick='popup()'> delete </a>
        
        <a href = 'update_product.php?editproduct=".$fieldname['product_id']."' class='edit'> edit </a>
