...
<?php
    foreach ($result as $fieldname) {
        ...
        <a href = 'delete_product_employee.php?deleteempproduct=".$fieldname['product_id']."' class='delete' onclick='popup()'> delete </a>
        
        <a href = 'update_product_employee.php?editempproduct=".$fieldname['product_id']."' class='edit'> edit </a>
...
if (isset($_POST['sub'])) {
   ...
   $results = $conn->query($insertsql);
    ...
    $logssql = "insert into tbl_logs (user_id, action, date) values ('".$userID."', 'Added new Product',NOW())";
 ...
 ?>
  ...
  <script>
        ...
        timer: 1500
            ...
            window.location.href = "employee_products.php";
        });
        </script>
